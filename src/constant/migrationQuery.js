const tableNameList = ['role','user','rating','privilege','user_role','product_type','product',
'buying_request','buying_request_product','selling_request_for_buying_request','business_product_type',
'selling_request','report','selling_request_report','selling_request_for_buying_request_report','image',
'selling_request_image','report_image','selling_request_for_buying_request_image','video','report_video',
'selling_request_video','selling_request_for_buying_request_video','notification','report_notification',
'selling_request_for_buying_request_notification','selling_request_notification','chat_room','message',
'message_file'];
...
const queryStringList = {
  ...
  product_type: `CREATE TABLE product_type (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY(root_type) REFERENCES product_type(id),
